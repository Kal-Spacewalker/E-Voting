    ...
    <div>
      ...
      <div className="overlay-content">
        ...
        <ul className="fancy-list">
          <li>Revolutionize democracy with our secure online voting platform,</li>
      ...
      <section className="cta">
        <div className="cta-content">
          <h2>Join thousands of others in shaping the future. Exercise your right to vote securely.</h2>
      ...
      <div className="container">
        ...
        <section className="features">
          ...
          <div className="feature">
            ...
            <h3>Security</h3>
            <p>Your vote is encrypted and securely stored on the blockchain, ensuring its integrity.</p>
          </div>
          <div className="feature">
            <img src={convenientIcon} alt="Convenient Icon" />
            <h3>Convenience</h3>
            <p>Vote from the comfort of your home, anytime during the voting period.</p>
          </div>
          <div className="feature">
            <img src={transparentIcon} alt="Transparent Icon" />
            <h3>Transparency</h3>
            <p>Blockchain technology ensures transparency and auditability of the voting process.</p>
          </div>
          <div className="feature">
            <img src={monitoringIcon} alt="Monitoring Icon" />
            <h3>Monitoring</h3>
            <p>Continuous monitoring to detect and mitigate potential security threats or vulnerabilitie. </p>
          </div>
      ...
      {/* <div className="about-us">
        <div className="aboutLabel">About Us</div>
        <section>
